...
console.log('');
console.log('Number of AFC West teams in the teamAndQBMap: ' + teamAndQBMap.length);
console.log('Number of non AFC West teams in the nonAFCWestMap: ' + nonAFCWestMap.length);
